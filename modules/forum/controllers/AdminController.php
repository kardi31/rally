...
class Forum_Admin extends Controller{
    ...
    public function render($viewName) {
     ...
     public function listSponsorData(){
         ...
         $results = $dataTables = Index_DataTables_Factory::factory(array(
            'table' => 'Forum_Model_Doctrine_SponsorList', 
	     ...
	     $options ='<a href="/admin/rally/edit-sponsor/id/'.$result['id'].'" class="btn default btn-xs purple"><i class="fa fa-edit"></i> Edit </a>';
             $options .='<a href="/admin/forum/delete-sponsor/id/'.$result['id'].'" class="btn default btn-xs blue"><i class="fa fa-list"></i> Delete </a>';
     ...
     public function addSponsor(){
        ...
        Service::loadModels('forum', 'forum');
        $sponsorService = parent::getService('forum','sponsor');
        $mediaService = parent::getService('media','media');
       
	$form = $this->getForm('forum','sponsor');
	...
	if(isset($_POST['form_send'])){
		...
		if(isset($_POST['submit']))
		    TK_Helper::redirect('/admin/forum/list-sponsor');
		
		if(isset($_POST['save_and_add_new']))
		    TK_Helper::redirect('/admin/forum/add-sponsor/');
		
		if(isset($_POST['save_and_stay']))
		    TK_Helper::redirect('/admin/forum/edit-sponsor/id/'.$stage['id']);
