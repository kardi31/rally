...
/**
 * Market_Model_Doctrine_BasePeopleDuplicate
 * 
 ...
 */
abstract class Market_Model_Doctrine_BasePeopleDuplicate extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('market_people_duplicate');
