...
class CardService extends Service{
    ...
    public function __construct(){
        $this->categoryTable = parent::getTable('card','category');
        $this->postTable = parent::getTable('card','post');
        $this->threadTable = parent::getTable('card','thread');
        $this->favouriteTable = parent::getTable('card','favourite');
    }
