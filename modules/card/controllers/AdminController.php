 ...
 * 
 */
class Card_Admin extends Controller{
    ...
    public function render($viewName) {
     ...
     public function listPostData(){
         ...
         $results = $dataTables = Index_DataTables_Factory::factory(array(
            'table' => 'Card_Model_Doctrine_Post', 
...
//             $row[] = $result['Thread']['Category']['name'];
             ...
             if($result['active'])
                 $row[] = '<a href="/admin/card/set-post-active/'.$result['id'].'"><span class="label label-sm label-success">Aktywny</span>';
             else
                 $row[] = '<a href="/admin/card/set-post-active/'.$result['id'].'"><span class="label label-sm label-danger">Nieaktywny</span>';
     ...
     public function listThreadData(){
         ...
         $results = $dataTables = Index_DataTables_Factory::factory(array(
            'table' => 'Card_Model_Doctrine_Thread', 
            'class' => 'Card_DataTables_Thread', 
...
//             $row[] = $result['Thread']['Category']['name'];
             ...
             $row[] = $result['User']['username'];
             if($result['active'])
                 $row[] = '<a href="/admin/card/set-thread-active/'.$result['id'].'"><span class="label label-sm label-success">Aktywny</span>';
             else
                 $row[] = '<a href="/admin/card/set-thread-active/'.$result['id'].'"><span class="label label-sm label-danger">Nieaktywny</span>';
	...
	TK_Helper::redirect('/admin/card/list-thread'); 
    }
	...
	TK_Helper::redirect('/admin/card/list-post'); 
    }
}
