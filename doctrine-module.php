...
$connection["library"] =
  ...
  $connection["data_fixtures_path"]= "/var/www/ral/modules/".$moduleName."/data/fixtures";
  $connection["migrations_path"]="/var/www/ral/modules/".$moduleName."/data/migrations";
  $connection["sql_path"]="/var/www/ral/modules/".$moduleName."/data/sql";
  $connection["yaml_schema_path"]= "/var/www/ral/modules/".$moduleName."/data/schema";
 ...
 $dir = __DIR__;
  ...
  $connection["models_path"] = "/var/www/ral/modules/".$moduleName."/models";
